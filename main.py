...
class Qr_Generator:
    def __init__(self,root):
        ...
        self.root.title("QR Generator | Developed by GUDDI YADAV");
        self.root.resizable(False,False);

        title=Label(self.root,text="    QR Code Generator",font=("times new roman",40),bg='#36013f',fg='white',anchor='w').place(x=0,y=0,relwidth=1)
       

       #---------------- Employee Details window------------------#

        #________________________variables______________________________#
        ...
        emp_title=Label(emp_Frame,text=" Employee Details",font=("goudy old style",30),bg='#36013f',fg='white').place(x=0,y=0,relwidth=1)
        ...
        btn_generate=Button(emp_Frame,text='QR Generate',command=self.generate,font=("times new roman",18,'bold'),bg='green',fg='white').place(x=90,y=250,width=200,height=30)
        btn_clear=Button(emp_Frame,text='Clear',command=self.clear,font=("times new roman",18,'bold'),bg='#D11A2A',fg='white').place(x=280,y=250,width=120,height=30)
        self.msg=''
        ...
        #________________Employee QR code window___________________#
        ...
        emp_title=Label(qr_Frame,text=" Employee QR Code",font=("goudy old style",20),bg='#36013f',fg='white').place(x=0,y=0,relwidth=1)
       
        self.qr_code=Label(qr_Frame,text='NO QR\n Available',font=('times new roman',15),bg='#36013f',fg='white')
